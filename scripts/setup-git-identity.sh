#!/bin/sh
# Run once after cloning (including at the start of any AI coding session working on this repo)
# to lock in the correct git identity and enable the pre-commit guard in .githooks/pre-commit.
#
