...
export function SetupScreen({
  ...
  // Whether "Custom" is the active choice for Overs per innings, rather than one of the T20/ODI
  // presets -- can't derive this from `overs` alone (tapping "Custom" while it's still "20" from
  // the T20 preset needs to reveal the number field without silently changing the value).
  const [oversCustom, setOversCustom] = useState(overs !== "20" && overs !== "50");
  ...
  // Guards "Start Match" against a double-tap: onStart (cricketScorer.js's startNewMatch) mints a
  // fresh match id and is synchronous, so without this, two clicks before the screen navigates
  // away create two separate matches -- same shape of bug as TeamEditScreen's own Save Team fix.
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    value: oversCustom ? "custom" : overs === "50" ? "odi" : "t20",
    onChange: v => {
      if (v === "custom") {
        setOversCustom(true);
        return;
      }
      setOversCustom(false);
      setOvers(v === "odi" ? "50" : "20");
    },
    options: [{
      value: "t20",
      label: "T20 (20 overs)"
  ...
  }), oversCustom && /*#__PURE__*/React.createElement("div", {
    style: {
      width: 64,
      marginBottom: 12
    }
  ...
  /*#__PURE__*/React.createElement(CoinFlipIllustration, {
  ...
  }, "Standard by default — adjust for junior or short formats."), ruleSectionToggle("batting", "Batting rules", true), expandedRuleSections.batting && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 14
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "No limit"))), React.createElement("div", {
    style: {
      marginTop: 14
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "None"))), ruleSectionToggle("extras", "Extras rules"), expandedRuleSections.extras && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(RuleChoice, {
  ...
  }, matchRules.superOver ? "On" : "Off"))))), currentPage === "xi" && (teamASquad.length > 0 || teamBSquad.length > 0) && /*#__PURE__*/React.createElement("div", {
    style: {
      ...cardStyle,
    ...
    variant: "primary",
    disabled: currentPage === "review" ? !canStart || starting : !pageValid,
    style: {
      flex: 2
    },
    onClick: () => {
  ...
  }, currentPage === "review" ? starting ? "Starting…" : "Start Match" : currentPageIndex === pageOrder.length - 2 ? "Review" : "Next")));
}
